...
# Replace everything from <main> up to the start of the footer
$content = $content -replace '(?s)<main>.*?<footer class="footer-custom">', "$newMain`r`n`r`n    <footer class=`"footer-custom`">"
